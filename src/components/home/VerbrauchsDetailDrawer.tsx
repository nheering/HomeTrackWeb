                      ...
                      <div className="flex items-center gap-1.5 mt-0.5 flex-wrap">
                        ...
                        {wert.bild_url && (
                          <button
                            ...
                            className="inline-flex items-center gap-1 ht-badge bg-accent/10 border border-accent/30 text-accent text-[10px] px-1.5 hover:bg-accent/20 transition-colors cursor-pointer"
                          >
